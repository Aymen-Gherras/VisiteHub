...
export default function PropertiesPage() {
  ...
  }, [filters.transactionType, filters.selectedPropertyType, filters.selectedWilaya, filters.selectedDaira, filters.searchQuery]);
  ...
  const Pagination = useMemo(() => {
    ...
    return (
      <div className="flex justify-center items-center gap-1.5 md:gap-2 mt-6 md:mt-8 mb-8 md:mb-12 px-2">
        {/* Previous Button */}
        <button
