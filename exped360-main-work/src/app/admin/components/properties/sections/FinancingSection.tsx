...
export default function FinancingSection({ 
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Filter out system fields and non-DTO fields (amenities, images)
      const { id, createdAt, updatedAt, viewCount, amenities, images, ...propertyDataForBackend } = propertyData;
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{propertyData.amenities?.length || 0} selected</span>
              </div>
              <div className="flex justify-between">
